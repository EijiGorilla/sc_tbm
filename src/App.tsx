    ...
    <>
      <CalciteShell>
        ...
        >
          ...
          />
          <b className="headerTitle">SC TBM TUNNEL</b>
          <div className="date">{!asOfDate ? '' : 'As of ' + asOfDate}</div>
          <CalciteSegmentedControl
            onCalciteSegmentedControlChange={(event: any) =>
              setSectionSelected(event.target.selectedItem.id)
            }
          >
            {sectionSelected &&
              sections.map((section: any, index: any) => {
                return (
                  <CalciteSegmentedControlItem
                    {...(sectionSelected === section ? { checked: true } : {})}
                    key={index}
                    value={section}
                    id={section}
                  >
          ...
          <CalcitePanel heading="Description" data-panel-id="information" hidden>
            {nextWidget === 'information' ? (
              <div className="informationDiv">
                <ul>
                  <li>
                    You can <b>filter TBM tunnels</b> by north-bound, south-bound, or both from the
                    segmented item list in the Header.
                  </li>
                  <br />
                  <br />
                </ul>
        ...
        {nextWidget === 'charts' && nextWidget !== activeWidget ? (
          <ProgressChart section={sectionSelected} />
        ) : (
          ''
        )}
      </CalciteShell>
